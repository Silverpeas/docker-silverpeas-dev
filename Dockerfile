...
# For instance, a Docker image with version 5.9.1 means it defines a development and build
# environment for a projet based upon Silverpeas 5.9 and it is the first corrective version of such
# a Docker image. The Silverpeas 5.9 can to be not yet released; in such a case, it means the Docker image is to
...
LABEL name="Silverpeas Dev" description="A Docker image to dev and to build a Silverpeas project" vendor="Silverpeas" version="5.9.3" build=1
